...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-[calc(100vh-4rem)] p-4">
      ...
      <div className="absolute top-20 right-[15%] w-64 h-64 bg-blue-400/20 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-20 left-[15%] w-80 h-80 bg-violet-400/15 rounded-full blur-3xl animate-float-delayed" />
      ...
      <Card className="relative z-10 w-full max-w-md glass rounded-2xl shadow-xl glow animate-slide-up">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription>Start building ATS-optimized resumes</CardDescription>
        </CardHeader>
